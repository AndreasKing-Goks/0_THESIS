...
addpath(fullfile('E:\Master Degree\Linux_file\Thesis\MIR_THESIS\Thruster_Dynamic'));

% Add the 'Ballast_Config_Input' path
addpath(fullfile('E:\Master Degree\Linux_file\Thesis\MIR_THESIS\Ballast_Config_Input'));

% Add the 'Util' path
addpath(fullfile('E:\Master Degree\Linux_file\Thesis\MIR_THESIS\Util'));
...
text(settling_time/2, 1600, 'Stabilizing Phase', 'FontSize', 10, 'Color', 'black', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle');
text((stop_time/dt + settling_time)/2, 1600, 'Maintain Phase', 'FontSize', 10, 'Color', 'black', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle');
