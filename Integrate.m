...
set_param('BlueROV2_Simu', 'StopTime', num2str(stop_time));
...
Total_Thruster_Force = simOut.Force_B_S;
...
% Integration Model
[eta_n, nu_b, nu_dot_b] = BlueROV2_Dynamic_Model2(dt, stop_time, accFunargs)
