...
legend_period = {'Transient Phase'};
settling_time  = 20/dt;

figure('Name', 'Trajectory Tracking', 'Position', [100, 100, 700, 900])

% Define colors for the plots
color1 = [0, 0.4470, 0.7410]; % blue
color2 = [0.8500, 0.3250, 0.0980]; % red

squeezedPos_N_S = squeeze(simOut.Pos_N_S)';

% Plot X
subplot(6,1,1);
plot(-simOut.eta_ref_n(:,1), 'LineWidth', 1.5, 'Color', color1);
hold on;
plot(-squeezedPos_N_S(:,1), 'LineWidth', 1.5, 'Color', color2);
title('Surge displacement', 'FontSize', 12);
...
text(settling_time/2, -0.25, 'Transient Phase', 'FontSize', 12, 'Color', 'black', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle');
text((stop_time/dt + settling_time)/2, -0.25, 'Steady-State Phase', 'FontSize', 12, 'Color', 'black', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle');
set(gca, 'Color', [0.9 0.9 0.9]);
...
% Plot Y
subplot(6,1,2);
plot(-simOut.eta_ref_n(:,2), 'LineWidth', 1.5, 'Color', color1);
hold on;
plot(-squeezedPos_N_S(:,2), 'LineWidth', 1.5, 'Color', color2);
title('Sway displacement', 'FontSize', 12);
ylabel('meter', 'FontSize', 10);
set(gca, 'Color', [0.9 0.9 0.9]);
grid on
xlim([0, stop_time/dt])
...
% Plot Z
subplot(6,1,3);
plot(-simOut.eta_ref_n(:,3), 'LineWidth', 1.5, 'Color', color1);
hold on;
plot(-squeezedPos_N_S(:,3), 'LineWidth', 1.5, 'Color', color2);
...
% Plot Phi
subplot(6,1,4);
plot(-simOut.eta_ref_n(:,4)/pi*180, 'LineWidth', 1.5, 'Color', color1);
hold on;
plot(-squeezedPos_N_S(:,4)/pi*180, 'LineWidth', 1.5, 'Color', color2);
...
y_fill = [yLimits(1), repmat(yLimits(1), 1, 100), yLimits(1), yLimits(2), yLimits(2)]; % Y coordinates
fill(x_fill, y_fill, 'red', 'EdgeColor', 'none', 'FaceAlpha', 0.1); % Fill the area with red color, semi-transparent
text(settling_time/2, -5, 'Transient Phase', 'FontSize', 12, 'Color', 'black', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle');
text((stop_time/dt + settling_time)/2, -5, 'Steady-State Phase', 'FontSize', 12, 'Color', 'black', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle');
set(gca, 'Color', [0.9 0.9 0.9]);
set(gcf, 'Color', 'w'); % white background for the figure
set(findall(gcf, 'Type', 'axes'), 'FontName', 'Helvetica', 'FontWeight', 'bold', 'FontSize', 10); % set font
hold off; % Release the plot for other operations
...
% Plot Theta
subplot(6,1,5);
plot(-simOut.eta_ref_n(:,5)/pi*180, 'LineWidth', 1.5, 'Color', color1);
hold on;
plot(-squeezedPos_N_S(:,5)/pi*180, 'LineWidth', 1.5, 'Color', color2);
...
xlim([0, stop_time/dt])
ylim([-10,10])
xticklabels(0:1/dt:stop_time); yLimits = ylim;
yline(0, 'k--');
x_fill = [0, linspace(0, settling_time, 100), settling_time, settling_time, 0]; % X coordinates for the filled area, closed loop
y_fill = [yLimits(1), repmat(yLimits(1), 1, 100), yLimits(1), yLimits(2), yLimits(2)]; % Y coordinates
fill(x_fill, y_fill, 'red', 'EdgeColor', 'none', 'FaceAlpha', 0.1); % Fill the area with red color, semi-transparent
...
% Plot Psi
subplot(6,1,6);
plot(-simOut.eta_ref_n(:,6)/pi*180, 'LineWidth', 1.5, 'Color', color1);
hold on;
plot(-squeezedPos_N_S(:,6)/pi*180, 'LineWidth', 1.5, 'Color', color2);
title('Yaw angle displacement', 'FontSize', 12);
ylabel('degree', 'FontSize', 10);
...
lgd = legend('Reference', 'Simulation', 'Orientation', 'horizontal', 'FontSize', 10, 'FontWeight', 'bold', 'FontName', 'Helvetica');
...
% Plot thrust
plot(squeeze(simOut.tau_b), 'LineWidth', 1.5)
hold on
...
text(settling_time/2, -2, 'Transient Phase', 'FontSize', 12, 'Color', 'black', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle');
text((stop_time/dt + settling_time)/2, -2, 'Steady-State Phase', 'FontSize', 12, 'Color', 'black', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle');
set(gca, 'Color', [0.9 0.9 0.9]);
set(gcf, 'Color', 'w'); % white background for the figure
set(findall(gcf, 'Type', 'axes'), 'FontName', 'Helvetica', 'FontWeight', 'bold', 'FontSize', 10); % set font
...
grid on
% title('Thrust Output for Ballast Estimation')
...
% Get the ballast configuration
%              FR     FL     AR     AL     IMR    IML    OMR    OML    W01   W02   W03   W04   W05   W06   W07   W08   W09   W10   W11   W12
% opt_prompt = {"NNF", "NFN", "FNF", "NFN", "FFF", "NNF", "NNN", "FFN", "WN", "WA", "WN", "WN", "WN", "WA", "WN", "WA", "WN", "WN", "WN", "WA"}; % FOR TESTING Case 1 Trial 2
% opt_prompt = {"NNF", "NFF", "NNN", "FFF", "NFF", "NNN", "NFF", "NNF", "WA", "WN", "WN", "WA", "WN", "WN", "WN", "WN", "WN", "WN", "WN", "WN"}; % FOR TESTING Case 2 Trial 4
% opt_prompt = {"NNN", "NFF", "NNF", "NFF", "NNN", "FFF", "NFN", "NFF", "WA", "WN", "WN", "WN", "WN", "WN", "WN", "WN", "WN", "WN", "WN", "WN"}; % FOR TESTING Case 3 Trial 4
% opt_prompt = {"NNN", "NNN", "FFF", "FFF", "FFF", "NNN", "NNN", "NFF", "WA", "WN", "WN", "WN", "WN", "WN", "WN", "WN", "WN", "WN", "WN", "WN"}; % FOR TESTING Case 4 Trial 2
% opt_prompt = {"FFN", "FFF", "NNN", "FFF", "NNN", "FFN", "FNN", "NNN", "WN", "WN", "WN", "WN", "WN", "WN", "WN", "WN", "WN", "WN", "WN", "WN"}; % FOR TESTING Case 5 Trial 2
opt_prompt = {"FFF", "FFF", "FNF", "NFN", "FFF", "NNF", "FFF", "NFF", "WN", "WN", "WN", "WA", "WN", "WN", "WA", "WN", "WA", "WN", "WN", "WN"}; % FOR TESTING Case 5 Trial 4
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% POSITION AND ORIENTATION COMPARISON PLOT
% Create figure
figure('Name', 'Position and Orientation Comparison', 'Position', [100, 100, 700, 900]);

% Title
title('Position and Orientation Comparison (With Ballast v. Without Ballast)')

% Define colors for the plots
color1 = [0, 0.4470, 0.7410]; % blue
color2 = [0.8500, 0.3250, 0.0980]; % red

% Define maximum value for each plot
max_surge = max(max(abs(ff_eta_n(:,1))), max(abs(nf_eta_n(:,1))));
max_sway = max(max(abs(ff_eta_n(:,2))), max(abs(nf_eta_n(:,2))));
max_heave = max(max(abs(ff_eta_n(:,3))), max(abs(nf_eta_n(:,3))));
max_roll = max(max(abs(ff_eta_n(:,4)/pi*180)), max(abs(nf_eta_n(:,4)/pi*180)));
max_pitch = max(max(abs(ff_eta_n(:,5)/pi*180)), max(abs(nf_eta_n(:,5)/pi*180)));
max_yaw = max(max(abs(ff_eta_n(:,6)/pi*180)), max(abs(nf_eta_n(:,6)/pi*180)));

% Plot X
subplot(6,1,1);
plot(ff_eta_n(:,1), 'LineWidth', 1.5, 'Color', color1);
hold on;
plot(nf_eta_n(:,1), 'LineWidth', 1.5, 'Color', color2);
title('Surge displacement', 'FontSize', 12);
ylabel('meter', 'FontSize', 10);
set(gca, 'Color', [0.9 0.9 0.9]);
grid on;
xlim([0, stop_time/dt]);
xticklabels(0:1/dt:stop_time);
ylim([-max_surge, max_surge]); % set y-axis limits
yline(0, 'k--');

% Plot Y
subplot(6,1,2);
plot(ff_eta_n(:,2), 'LineWidth', 1.5, 'Color', color1);
hold on;
plot(nf_eta_n(:,2), 'LineWidth', 1.5, 'Color', color2);
title('Sway displacement', 'FontSize', 12);
ylabel('meter', 'FontSize', 10);
set(gca, 'Color', [0.9 0.9 0.9]);
grid on;
xlim([0, stop_time/dt]);
xticklabels(0:1/dt:stop_time);
ylim([-max_sway, max_sway]); % set y-axis limits
yline(0, 'k--');

% Plot Z
subplot(6,1,3);
plot(ff_eta_n(:,3), 'LineWidth', 1.5, 'Color', color1);
hold on;
plot(nf_eta_n(:,3), 'LineWidth', 1.5, 'Color', color2);
title('Heave displacement', 'FontSize', 12);
ylabel('meter', 'FontSize', 10);
set(gca, 'Color', [0.9 0.9 0.9]);
grid on;
xlim([0, stop_time/dt]);
xticklabels(0:1/dt:stop_time);
ylim([-max_heave, max_heave]); % set y-axis limits
yline(0, 'k--');

% Plot Phi
subplot(6,1,4);
plot(ff_eta_n(:,4)/pi*180, 'LineWidth', 1.5, 'Color', color1);
hold on;
plot(nf_eta_n(:,4)/pi*180, 'LineWidth', 1.5, 'Color', color2);
title('Roll angle displacement', 'FontSize', 12);
ylabel('degree', 'FontSize', 10);
set(gca, 'Color', [0.9 0.9 0.9]);
grid on;
xlim([0, stop_time/dt]);
xticklabels(0:1/dt:stop_time);
ylim([-max_roll, max_roll]); % set y-axis limits
yline(0, 'k--');

% Plot Theta
subplot(6,1,5);
plot(ff_eta_n(:,5)/pi*180, 'LineWidth', 1.5, 'Color', color1);
hold on;
plot(nf_eta_n(:,5)/pi*180, 'LineWidth', 1.5, 'Color', color2);
title('Pitch angle displacement', 'FontSize', 12);
ylabel('degree', 'FontSize', 10);
set(gca, 'Color', [0.9 0.9 0.9]);
grid on;
xlim([0, stop_time/dt]);
xticklabels(0:1/dt:stop_time);
ylim([-max_pitch, max_pitch]); % set y-axis limits
yline(0, 'k--');

% Plot Psi
subplot(6,1,6);
plot(ff_eta_n(:,6)/pi*180, 'LineWidth', 1.5, 'Color', color1);
hold on;
plot(nf_eta_n(:,6)/pi*180, 'LineWidth', 1.5, 'Color', color2);
title('Yaw angle displacement', 'FontSize', 12);
ylabel('degree', 'FontSize', 10);
xlabel('Time (second)', 'FontSize', 10);
set(gca, 'Color', [0.9 0.9 0.9]);
...
xlim([0, stop_time/dt]);
xticklabels(0:1/dt:stop_time);
ylim([-max_yaw, max_yaw]); % set y-axis limits
yline(0, 'k--');
...
% Create a single legend for the entire figure
lgd = legend('With Ballast', 'Without Ballast', 'Orientation', 'horizontal', 'FontSize', 10, 'FontWeight', 'bold', 'FontName', 'Helvetica');
lgd.Position = [0.4, 0.01, 0.2, 0.05];
...
% % Create figure
% figure('Name', 'Velocity Comparison', 'Position', [100, 100, 700, 900]);
% 
% % Title
% title('Velocity Comparison (With Ballast v. Without Ballast)')
% 
% % Define colors for the plots
% color1 = [0, 0.4470, 0.7410]; % blue
% color2 = [0.8500, 0.3250, 0.0980]; % red
...
% % Plot X
% subplot(6,1,1);
% plot(ff_nu_b(:,1), 'LineWidth', 1.5, 'Color', color1);
% hold on;
% plot(nf_nu_b(:,1), 'LineWidth', 1.5, 'Color', color2);
% title('Surge velocity', 'FontSize', 12);
...
% % Plot Y
% subplot(6,1,2);
% plot(ff_nu_b(:,2), 'LineWidth', 1.5, 'Color', color1);
% hold on;
% plot(nf_nu_b(:,2), 'LineWidth', 1.5, 'Color', color2);
% title('Sway velocity', 'FontSize', 12);
% ylabel('m.s-1', 'FontSize', 10);
% set(gca, 'Color', [0.9 0.9 0.9]);
% grid on
% xlim([0, stop_time/dt])
...
% % Plot Z
% subplot(6,1,3);
% plot(ff_nu_b(:,3), 'LineWidth', 1.5, 'Color', color1);
% hold on;
% plot(nf_nu_b(:,3), 'LineWidth', 1.5, 'Color', color2);
% title('Heave velocity', 'FontSize', 12);
% ylabel('m.s-1', 'FontSize', 10);
% set(gca, 'Color', [0.9 0.9 0.9]);
% grid on
% xlim([0, stop_time/dt])
...
% % Plot Phi
% subplot(6,1,4);
% plot(ff_nu_b(:,4), 'LineWidth', 1.5, 'Color', color1);
% hold on;
% plot(nf_nu_b(:,4), 'LineWidth', 1.5, 'Color', color2);
% title('Roll velocity', 'FontSize', 12);
% ylabel('rad.s-1', 'FontSize', 10);
% set(gca, 'Color', [0.9 0.9 0.9]);
% grid on
% xlim([0, stop_time/dt])
% xticklabels(0:1/dt:stop_time); 
...
% % Plot Theta
% subplot(6,1,5);
% plot(ff_nu_b(:,5), 'LineWidth', 1.5, 'Color', color1);
% hold on;
% plot(nf_nu_b(:,5), 'LineWidth', 1.5, 'Color', color2);
% title('Pitch velocity', 'FontSize', 12);
% ylabel('rad.s-1', 'FontSize', 10);
% set(gca, 'Color', [0.9 0.9 0.9]);
% grid on
% xlim([0, stop_time/dt])
...
% % Plot Psi
% subplot(6,1,6);
% plot(ff_nu_b(:,6), 'LineWidth', 1.5, 'Color', color1);
% hold on;
% plot(nf_nu_b(:,6), 'LineWidth', 1.5, 'Color', color2);
% title('Yaw velocity', 'FontSize', 12);
% ylabel('rad.s-1', 'FontSize', 10);
% xlabel('Time (second)', 'FontSize', 10);
% set(gca, 'Color', [0.9 0.9 0.9]);
% grid on
...
% % Create figure
% figure('Name', 'Acceleration Comparison', 'Position', [100, 100, 700, 900]);
% 
% % Title
% title('Acceleration Comparison (With Ballast v. Without Ballast)')
% 
% % Define colors for the plots
% color1 = [0, 0.4470, 0.7410]; % blue
% color2 = [0.8500, 0.3250, 0.0980]; % red
...
% % Plot X
% subplot(6,1,1);
% plot(ff_nu_dot_b(:,1), 'LineWidth', 1.5, 'Color', color1);
% hold on;
% plot(nf_nu_dot_b(:,1), 'LineWidth', 1.5, 'Color', color2);
% title('Surge acceleration', 'FontSize', 12);
% ylabel('m.s-2', 'FontSize', 10);
% set(gca, 'Color', [0.9 0.9 0.9]);
% grid on
% xlim([0, stop_time/dt])
% xticklabels(0:1/dt:stop_time); 
...
% % Plot Y
% subplot(6,1,2);
% plot(ff_nu_dot_b(:,2), 'LineWidth', 1.5, 'Color', color1);
% hold on;
% plot(nf_nu_dot_b(:,2), 'LineWidth', 1.5, 'Color', color2);
% title('Sway acceleration', 'FontSize', 12);
% ylabel('m.s-2', 'FontSize', 10);
% set(gca, 'Color', [0.9 0.9 0.9]);
% grid on
% xlim([0, stop_time/dt])
...
% % Plot Z
% subplot(6,1,3);
% plot(ff_nu_dot_b(:,3), 'LineWidth', 1.5, 'Color', color1);
% hold on;
% plot(nf_nu_dot_b(:,3), 'LineWidth', 1.5, 'Color', color2);
% title('Heave acceleration', 'FontSize', 12);
% ylabel('m.s-2', 'FontSize', 10);
% set(gca, 'Color', [0.9 0.9 0.9]);
% grid on
% xlim([0, stop_time/dt])
...
% % Plot Phi
% subplot(6,1,4);
% plot(ff_nu_dot_b(:,4), 'LineWidth', 1.5, 'Color', color1);
% hold on;
% plot(nf_nu_dot_b(:,4), 'LineWidth', 1.5, 'Color', color2);
% title('Roll acceleration', 'FontSize', 12);
% ylabel('rad.s-2', 'FontSize', 10);
% set(gca, 'Color', [0.9 0.9 0.9]);
% grid on
% xlim([0, stop_time/dt])
% xticklabels(0:1/dt:stop_time); 
...
% % Plot Theta
% subplot(6,1,5);
% plot(ff_nu_dot_b(:,5), 'LineWidth', 1.5, 'Color', color1);
% hold on;
% plot(nf_nu_dot_b(:,5), 'LineWidth', 1.5, 'Color', color2);
% title('Pitch acceleration', 'FontSize', 12);
% ylabel('rad.s-2', 'FontSize', 10);
% set(gca, 'Color', [0.9 0.9 0.9]);
% grid on
% xlim([0, stop_time/dt])
...
% % Plot Psi
% subplot(6,1,6);
% plot(ff_nu_dot_b(:,6), 'LineWidth', 1.5, 'Color', color1);
% hold on;
% plot(nf_nu_dot_b(:,6), 'LineWidth', 1.5, 'Color', color2);
% title('Yaw acceleration', 'FontSize', 12);
% ylabel('rad.s-2', 'FontSize', 10);
% xlabel('Time (second)', 'FontSize', 10);
% set(gca, 'Color', [0.9 0.9 0.9]);
% grid on
