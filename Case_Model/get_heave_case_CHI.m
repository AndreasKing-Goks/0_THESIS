function [X_ref, Y_ref, Z_ref, Phi_ref, Theta_ref, Psi_ref, resampled_time] = get_heave_case_CHI(idle_time, stop_time, dt)
...
[Z_ref, resampled_time] = Reference_Model_CHI(set_points_z,step_value);
