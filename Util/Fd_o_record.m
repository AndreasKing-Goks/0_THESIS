function [Fd_o, Fld_o, Fnld_o] = Fd_o_record(Pos_N, Velo_B)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% BlueROV2_acc()                                                          %
%                                                                         %
...
L_Damping_Coeff = [Xu_l Yv_l Zw_l Kp_l Mq_l Nr_l];

Fld = -diag(L_Damping_Coeff) * V_t_b; 
Fld_o = (H_(CB.rb_o))' * Fld;
...
NL_Damping_Coeff = [Xu_nl Yv_nl Zw_nl Kp_nl Mq_nl Nr_nl];

Fnld = -diag(NL_Damping_Coeff) * abs(V_t_b) .* V_t_b;
Fnld_o = (H_(CB.rb_o))' * Fnld;
