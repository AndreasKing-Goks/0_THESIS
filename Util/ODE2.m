function [eta_dot_n, nu_dot_b] = ODE2(t, eta_n, nu_b, accFunargs, dt)
global Param
...
nu_dot_b = BlueROV2_acc_NIF2(Ballast_Force, Body_Force, Tether_Force, eta_n, nu_b, NIF_AM, NIF_K_l, NIF_K_nl);
